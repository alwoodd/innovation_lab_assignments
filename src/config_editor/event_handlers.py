...
def on_click_save():
    ...
    #config.get_instance().set_sheets(new_sheets_dict)
...
def on_combo_select(event):
    ...
    build_activity_rows(AppWidgetStore.get_instance().get_widget(AppWidgetId.ACTIVITIES_FRAME),
                        AppWidgetStore.get_instance().get_widget(AppWidgetId.DAY_COMBO).get())